...
public:
    ...
    // 设置游戏速度倍率（1 = 正常，2 = 双倍速），影响所有塔的射击间隔
    static void setGameSpeed(int speed);
    static int gameSpeed();  // 获取当前倍率

    QPointF centerPosition() const; // 返回炮塔实际中心点
...
private:
    ...
    static int s_gameSpeed;  // 全局射击速度倍率，默认 1
};
